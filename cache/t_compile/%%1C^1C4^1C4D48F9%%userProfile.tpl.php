<?php /* Smarty version 2.6.26, created on 2022-02-10 11:24:23
         compiled from trackDirector/userProfile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'trackDirector/userProfile.tpl', 16, false),array('function', 'url', 'trackDirector/userProfile.tpl', 62, false),array('function', 'icon', 'trackDirector/userProfile.tpl', 63, false),array('modifier', 'escape', 'trackDirector/userProfile.tpl', 16, false),array('modifier', 'nl2br', 'trackDirector/userProfile.tpl', 51, false),array('modifier', 'concat', 'trackDirector/userProfile.tpl', 61, false),array('modifier', 'to_array', 'trackDirector/userProfile.tpl', 62, false),array('modifier', 'assign', 'trackDirector/userProfile.tpl', 62, false),array('modifier', 'strip_unsafe_html', 'trackDirector/userProfile.tpl', 88, false),array('modifier', 'date_format', 'trackDirector/userProfile.tpl', 104, false),)), $this); ?>
...
:</td>
	<td class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['user']->getAffiliation())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</td>
</tr>
<tr valign="top">
...
:</td>
	<td class="value"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getLocalizedInterests())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td>
</tr>
<tr valign="top">
